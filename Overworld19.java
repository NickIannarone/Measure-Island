...
public class Overworld19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overworld19);

        //To start background music:
        player = MediaPlayer.create(this, R.raw.sealevel3);
    ...
    public void hitMenu(View v)
    {
        ...
        startActivity(new Intent(Overworld19.this, Menu.class));
    }
        ...
        downArrow.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (((int) SystemClock.elapsedRealtime()) - baseTime >= 2000 && Data.battle19Done == false){
                        //Play the start battle sound effect
                        player2 = MediaPlayer.create(Overworld19.this, R.raw.startbattle);
                        player2.start();
                        ...
                        Data.location = getClass();
                        Data.screenNumber = 19;
                        Data.inBattle = true;

                        //Start the battle
                        player.stop();
                        startActivity(new Intent(Overworld19.this, Battle.class));
                        player2 = MediaPlayer.create(Overworld19.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.leftBorder))) {
                        ...
                        startActivity(new Intent(Overworld19.this, Overworld18.class));
                        player2 = MediaPlayer.create(Overworld19.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.rightBorder))) {
                        ...
                        startActivity(new Intent(Overworld19.this, Overworld20.class));
                        player2 = MediaPlayer.create(Overworld19.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
