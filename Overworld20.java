...
public class Overworld20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overworld20);

        //To start background music:
        player = MediaPlayer.create(this, R.raw.scarytheme);
        ...
        if (Data.killedSeaBoss){
            View layout = findViewById(R.id.overworld20);
            layout.setBackgroundResource(R.drawable.seabg20bossclear);
        }
    }
    ...
    public void hitMenu(View v)
    {
        ...
        startActivity(new Intent(Overworld20.this, Menu.class));
    }
        ...
        downArrow.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (((int)SystemClock.elapsedRealtime()) - baseTime >= 3000 && Data.killedSeaBoss == false){
                        //Play the start battle sound effect
                        player2 = MediaPlayer.create(Overworld20.this, R.raw.startbattle);
                        player2.start();

                        downArrow.setEnabled(false);

                        //Set all the necessary Data values
                        Data.monsters.add(Data.seaBoss);
                        Data.background = R.drawable.seabattleboss;
                        Data.location = getClass();
                        Data.screenNumber = 20;
                        Data.inBattle = true;

                        //Start the battle
                        player.stop();
                        startActivity(new Intent(Overworld20.this, Battle.class));
                        player2 = MediaPlayer.create(Overworld20.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.leftBorder))) {
                        ...
                        startActivity(new Intent(Overworld20.this, Overworld19.class));
                        player2 = MediaPlayer.create(Overworld20.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.rightBorder))) {
                        ...
                        if (Data.killedSeaBoss)
                        startActivity(new Intent(Overworld20.this, Overworld21.class));
