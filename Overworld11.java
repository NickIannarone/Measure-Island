...
public class Overworld11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overworld11);
    ...
    public void hitMenu(View v)
    {
        ...
        startActivity(new Intent(Overworld11.this, Menu.class));
    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.bottomBorder))) {
                        ...
                        startActivity(new Intent(Overworld11.this, Overworld15.class));
                        player2 = MediaPlayer.create(Overworld11.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.leftBorder))) {
                        ...
                        startActivity(new Intent(Overworld11.this, Overworld10.class));
                        player2 = MediaPlayer.create(Overworld11.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.topBorder))) {
                        ...
                        startActivity(new Intent(Overworld11.this, Overworld12.class));
                        player2 = MediaPlayer.create(Overworld11.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
