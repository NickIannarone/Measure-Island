...
public class Overworld8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overworld8);
    ...
    public void hitMenu(View v)
    {
        ...
        startActivity(new Intent(Overworld8.this, Menu.class));
    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.bottomBorder))) {
                        ...
                        startActivity(new Intent(Overworld8.this, Overworld9.class));
                        player2 = MediaPlayer.create(Overworld8.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.topBorder))) {
                        ...
                        startActivity(new Intent(Overworld8.this, Overworld6.class));
                        player2 = MediaPlayer.create(Overworld8.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
