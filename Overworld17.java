...
public class Overworld17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overworld17);

        //To start background music:
        player = MediaPlayer.create(this, R.raw.sealevel1);
    ...
    public void hitMenu(View v)
    {
        ...
        startActivity(new Intent(Overworld17.this, Menu.class));
    }
...
/*
                    if (((int) SystemClock.elapsedRealtime()) - baseTime >= 2000 && Data.battle17Done == false) {
                        //Play the start battle sound effect
                        player2 = MediaPlayer.create(Overworld17.this, R.raw.startbattle);
                        player2.start();
                        ...
                        Data.location = getClass();
                        Data.screenNumber = 17;
                        Data.inBattle = true;

                        //Start the battle
                        player.stop();
                        startActivity(new Intent(Overworld17.this, Battle.class));
                        return false;
                    }
*/
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.bottomBorder))) {
                        ...
                        if (Data.foundGhostKey) {
                            startActivity(new Intent(Overworld17.this, Overworld18.class));
                            player2 = MediaPlayer.create(Overworld17.this, R.raw.sound2);
                            player2.start();
                            return false;
                        }
                    }
...
*/
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.topBorder))) {
                        ...
                        startActivity(new Intent(Overworld17.this, Overworld16.class));
                        return false;
                    }
