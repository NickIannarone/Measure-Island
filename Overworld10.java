...
public class Overworld10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overworld10);
    ...
    public void hitMenu(View v)
    {
        ...
        startActivity(new Intent(Overworld10.this, Menu.class));
    }
        ...
        downArrow.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (((int) SystemClock.elapsedRealtime()) - baseTime >= 2000 && Data.battle10Done == false) {
                        //Play the start battle sound effect
                        player2 = MediaPlayer.create(Overworld10.this, R.raw.startbattle);
                        player2.start();

                        downArrow.setEnabled(false);

                        //Set all the necessary Data values
                        Data.monsters.add(Data.sea1);
                        Data.background = R.drawable.seabattle1;
                        Data.location = getClass();
                        Data.screenNumber = 10;
                        Data.inBattle = true;

                        //Start the battle
                        player.stop();
                        startActivity(new Intent(Overworld10.this, Battle.class));
                        player2 = MediaPlayer.create(Overworld10.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.bottomBorder))) {
                        ...
                        startActivity(new Intent(Overworld10.this, Overworld14.class));
                        player2 = MediaPlayer.create(Overworld10.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.leftBorder))) {
                        ...
                        startActivity(new Intent(Overworld10.this, Overworld9.class));
                        player2 = MediaPlayer.create(Overworld10.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.rightBorder))) {
                        ...
                        startActivity(new Intent(Overworld10.this, Overworld11.class));
                        player2 = MediaPlayer.create(Overworld10.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
