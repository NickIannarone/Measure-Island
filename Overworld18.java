...
public class Overworld18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overworld18);
    ...
    public void hitMenu(View v)
    {
        ...
        startActivity(new Intent(Overworld18.this, Menu.class));
    }
        ...
        downArrow.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (((int) SystemClock.elapsedRealtime()) - baseTime >= 2000 && Data.battle18Done == false) {
                        //Play the start battle sound effect
                        player2 = MediaPlayer.create(Overworld18.this, R.raw.startbattle);
                        player2.start();
                        ...
                        Data.location = getClass();
                        Data.screenNumber = 18;
                        Data.inBattle = true;

                        //Start the battle
                        player.stop();
                        startActivity(new Intent(Overworld18.this, Battle.class));
                        player2 = MediaPlayer.create(Overworld18.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.topBorder))) {
                        ...
                        startActivity(new Intent(Overworld18.this, Overworld17.class));
                        player2 = MediaPlayer.create(Overworld18.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.rightBorder))) {
                        ...
                        startActivity(new Intent(Overworld18.this, Overworld19.class));
                        player2 = MediaPlayer.create(Overworld18.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
