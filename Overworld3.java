...
public class Overworld3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overworld3);
    ...
    public void hitMenu(View v)
    {
        ...
        startActivity(new Intent(Overworld3.this, Menu.class));
    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.leftBorder))) {
                        ...
                        //startActivity(new Intent(Overworld3.this, Overworld22.class));
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.topBorder))) {
                        ...
                        startActivity(new Intent(Overworld3.this, Main3Activity.class));
                        player2 = MediaPlayer.create(Overworld3.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
