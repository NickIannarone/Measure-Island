...
public class Overworld16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overworld16);
    ...
    public void hitMenu(View v)
    {
        ...
        startActivity(new Intent(Overworld16.this, Menu.class));
    }
...
/*
                    if (((int) SystemClock.elapsedRealtime()) - baseTime >= 2000 && Data.battle16Done == false) {
                        //Play the start battle sound effect
                        player2 = MediaPlayer.create(Overworld16.this, R.raw.startbattle);
                        player2.start();

                        downArrow.setEnabled(false);

                        //Set all the necessary Data values
                        Data.monsters.add(Data.sea3);
                        Data.background = R.drawable.seabattle2;
                        Data.location = getClass();
                        Data.screenNumber = 16;
                        Data.inBattle = true;

                        //Start the battle
                        player.stop();
                        startActivity(new Intent(Overworld16.this, Battle.class));
                        return false;
                    }
*/
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.bottomBorder))) {
                        ...
                        if (Data.foundGhostKey) {
                            startActivity(new Intent(Overworld16.this, Overworld20.class));
                            return false;
                        }
                    }
...
*/
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.topBorder))) {
                        ...
                        startActivity(new Intent(Overworld16.this, Overworld14.class));
                        player2 = MediaPlayer.create(Overworld16.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
