...
public class Overworld14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overworld14);
    ...
    public void hitMenu(View v)
    {
        ...
        startActivity(new Intent(Overworld14.this, Menu.class));
    }
        ...
        downArrow.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (((int) SystemClock.elapsedRealtime()) - baseTime >= 2000 && Data.battle14Done == false) {
                        //Play the start battle sound effect
                        player2 = MediaPlayer.create(Overworld14.this, R.raw.startbattle);
                        player2.start();

                        downArrow.setEnabled(false);

                        //Set all the necessary Data values
                        Data.monsters.add(Data.sea5);
                        Data.background = R.drawable.seabattle1;
                        Data.location = getClass();
                        Data.screenNumber = 14;
                        Data.inBattle = true;

                        //Start the battle
                        player.stop();
                        startActivity(new Intent(Overworld14.this, Battle.class));
                        player2 = MediaPlayer.create(Overworld14.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.bottomBorder))) {
                        ...
                        startActivity(new Intent(Overworld14.this, Overworld16.class));
                        player2 = MediaPlayer.create(Overworld14.this, R.raw.sound2);
                        player2.start();
                        return false;
                        }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.leftBorder))) {
                        ...
                        startActivity(new Intent(Overworld14.this, Overworld13.class));
                        player2 = MediaPlayer.create(Overworld14.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.topBorder))) {
                        ...
                        startActivity(new Intent(Overworld14.this, Overworld10.class));
                        player2 = MediaPlayer.create(Overworld14.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.rightBorder))) {
                        ...
                        startActivity(new Intent(Overworld14.this, Overworld15.class));
                        player2 = MediaPlayer.create(Overworld14.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
