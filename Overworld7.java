...
public class Overworld7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overworld7);
    ...
    public void hitMenu(View v)
    {
        ...
        startActivity(new Intent(Overworld7.this, Menu.class));
    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.leftBorder))) {
                        ...
                        startActivity(new Intent(Overworld7.this, Overworld6.class));
                        player2 = MediaPlayer.create(Overworld7.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
