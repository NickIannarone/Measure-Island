...
public class Overworld21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overworld21);

        //To start background music:
        player = MediaPlayer.create(this, R.raw.mainthemesea);
    ...
    public void hitMenu(View v)
    {
        ...
        startActivity(new Intent(Overworld21.this, Menu.class));
    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.leftBorder))) {
                        ...
                        Data.battle19Done = false;
                        Data.battle18Done = false;
                        Data.battle14Done = false;
                        Data.battle13Done = false;
                        Data.battle10Done = false;

                        startActivity(new Intent(Overworld21.this, Overworld20.class));
                        return false;
                    }
