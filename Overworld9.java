...
public class Overworld9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overworld9);
    ...
    public void hitMenu(View v)
    {
        ...
        startActivity(new Intent(Overworld9.this, Menu.class));
    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.bottomBorder))) {
                        ...
                        startActivity(new Intent(Overworld9.this, Overworld13.class));
                        player2 = MediaPlayer.create(Overworld9.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.topBorder))) {
                        ...
                        startActivity(new Intent(Overworld9.this, Overworld8.class));
                        player2 = MediaPlayer.create(Overworld9.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.rightBorder))) {
                        ...
                        startActivity(new Intent(Overworld9.this, Overworld10.class));
                        player2 = MediaPlayer.create(Overworld9.this, R.raw.sound2);
                        player2.start();
                        return false;
                    }
