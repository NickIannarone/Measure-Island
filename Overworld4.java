...
public class Overworld4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overworld4);
    ...
    public void hitMenu(View v)
    {
        ...
        startActivity(new Intent(Overworld4.this, Menu.class));
    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.leftBorder))) {
                        ...
                        //startActivity(new Intent(Overworld4.this, Overworld28.class));
                        return false;
                    }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() != MotionEvent.ACTION_CANCEL) {
                    ...
                    if (isViewOverlapping(avatar, findViewById(R.id.rightBorder))) {
                        ...
                        //startActivity(new Intent(Overworld4.this, Main3Activity.class));
                        return false;
                    }
